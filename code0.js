...
gdjs.OverworldCode.GDMatcha_9595MouseObjects1= [];
gdjs.OverworldCode.GDMatcha_9595MouseObjects2= [];
gdjs.OverworldCode.GDMatcha_9595MouseObjects3= [];
gdjs.OverworldCode.GDMatcha_9595MouseObjects4= [];
...
gdjs.OverworldCode.mapOfGDgdjs_9546OverworldCode_9546GDMatcha_95959595MouseObjects2Objects = Hashtable.newFrom({"Matcha_Mouse": gdjs.OverworldCode.GDMatcha_9595MouseObjects2});
...
gdjs.OverworldCode.asyncCallback16523948 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1.25), (runtimeScene) => (gdjs.OverworldCode.asyncCallback16523948(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.copyArray(runtimeScene.getObjects("Matcha_Mouse"), gdjs.OverworldCode.GDMatcha_9595MouseObjects2);
...
}{for(var i = 0, len = gdjs.OverworldCode.GDMatcha_9595MouseObjects2.length ;i < len;++i) {
    gdjs.OverworldCode.GDMatcha_9595MouseObjects2[i].activateBehavior("TopDownMovement", true);
}
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(16521412);
}
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.distanceTest(gdjs.OverworldCode.mapOfGDgdjs_9546OverworldCode_9546GDMatcha_95959595MouseObjects2Objects, gdjs.OverworldCode.mapOfGDgdjs_9546OverworldCode_9546GDNPCObjects2Objects, 20, false);
}
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("DialogBox"), gdjs.OverworldCode.GDDialogBoxObjects2);
gdjs.copyArray(runtimeScene.getObjects("E"), gdjs.OverworldCode.GDEObjects2);
/* Reuse gdjs.OverworldCode.GDMatcha_9595MouseObjects2 */
{for(var i = 0, len = gdjs.OverworldCode.GDDialogBoxObjects2.length ;i < len;++i) {
    ...
    gdjs.OverworldCode.GDMatcha_9595MouseObjects2[i].activateBehavior("TopDownMovement", false);
}
...
gdjs.copyArray(runtimeScene.getObjects("Matcha_Mouse"), gdjs.OverworldCode.GDMatcha_9595MouseObjects1);
...
}{for(var i = 0, len = gdjs.OverworldCode.GDMatcha_9595MouseObjects1.length ;i < len;++i) {
    gdjs.OverworldCode.GDMatcha_9595MouseObjects1[i].activateBehavior("TopDownMovement", true);
}
}}
...
for(var i = 0, len = gdjs.OverworldCode.GDTilemap_9595WaterObjects1.length ;i < len;++i) {
    ...
    gdjs.OverworldCode.GDBush1Objects1[i].getBehavior("Scale").setScale(0.5);
}
}{gdjs.evtTools.sound.playMusic(runtimeScene, "song.wav", true, 50, 1);
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.OverworldCode.GDMatcha_9595MouseObjects1.length;i<l;++i) {
    if ( !(gdjs.OverworldCode.GDMatcha_9595MouseObjects1[i].getBehavior("TopDownMovement").isMoving()) ) {
        isConditionTrue_0 = true;
        gdjs.OverworldCode.GDMatcha_9595MouseObjects1[k] = gdjs.OverworldCode.GDMatcha_9595MouseObjects1[i];
        ++k;
    }
}
gdjs.OverworldCode.GDMatcha_9595MouseObjects1.length = k;
if (isConditionTrue_0) {
/* Reuse gdjs.OverworldCode.GDMatcha_9595MouseObjects1 */
{for(var i = 0, len = gdjs.OverworldCode.GDMatcha_9595MouseObjects1.length ;i < len;++i) {
    gdjs.OverworldCode.GDMatcha_9595MouseObjects1[i].setAnimationFrame(0);
}
}}
...
gdjs.OverworldCode.GDMatcha_9595MouseObjects1.length = 0;
gdjs.OverworldCode.GDMatcha_9595MouseObjects2.length = 0;
gdjs.OverworldCode.GDMatcha_9595MouseObjects3.length = 0;
gdjs.OverworldCode.GDMatcha_9595MouseObjects4.length = 0;
